...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("collab", "Read collaboration.ktl.com PM state and monitors", "Tools & Skills",
               cli_only=True, gateway_config_gate="collaboration.gateway_brief_enabled",
               args_hint="[brief|dashboard|requests|overdue|blockers|reports|project <name>|inbox|monitor]",
               subcommands=("brief", "dashboard", "requests", "overdue", "blockers", "reports", "project", "inbox", "monitor")),
