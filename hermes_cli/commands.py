...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("collab", "Read collaboration.ktl.com PM state", "Tools & Skills",
               cli_only=True, gateway_config_gate="collaboration.gateway_brief_enabled",
               args_hint="[brief|dashboard|requests|overdue|blockers|reports|project <name>|monitor]",
               subcommands=("brief", "dashboard", "requests", "overdue", "blockers", "reports", "project", "monitor")),
