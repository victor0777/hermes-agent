...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("collab", "Read collaboration.ktl.com PM state, monitors, digests, and approval-gated response drafts", "Tools & Skills",
               ...
               args_hint="[brief|dashboard|requests|overdue|blockers|reports|project <name>|inbox|respond|autonomy|pm|monitor]",
               subcommands=("brief", "dashboard", "requests", "overdue", "blockers", "reports", "project", "inbox", "respond", "autonomy", "pm", "monitor")),
