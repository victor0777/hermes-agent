...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("collab", "Read collaboration.ktl.com PM state, monitors, digests, and approval-gated response drafts", "Tools & Skills",
               cli_only=True, gateway_config_gate="collaboration.gateway_brief_enabled",
               args_hint="[brief|dashboard|requests|overdue|blockers|reports|project <name>|inbox|respond|autonomy|pm|monitor|security-intel]",
               subcommands=("brief", "dashboard", "requests", "overdue", "blockers", "reports", "project", "inbox", "respond", "autonomy", "pm", "monitor", "security-intel")),
