...
DEFAULT_CONFIG = {
    ...
    "collaboration": {
        ...
        "monitor": {
            ...
            "inbound_schedule": "every 30m",
            "deliver": "local",
            "limit": 20,
            "project": "",
            "inbound_mark_seen_on_run": True,
            "inbound_state_path": "",
            "inbound_inbox_path": "",
...
OPTIONAL_ENV_VARS = {
    ...
    "COLLABORATION_BASE_URL": {
        "description": "Base URL for the read-only collaboration PM API",
        "prompt": "Collaboration base URL",
        "url": None,
        "password": False,
        "tools": ["collaboration"],
        "category": "tool",
    ...
    "WEBHOOK_HOST": {
        "description": "Host/bind address for the webhook HTTP server (default: 127.0.0.1). Use 0.0.0.0 only behind trusted auth/proxy controls.",
        "prompt": "Webhook host",
        "url": None,
        "password": False,
        "category": "messaging",
    ...
    "TELEGRAM_WEBHOOK_HOST": {
        "description": "Local bind host for Telegram webhook mode (default: 127.0.0.1). Use 0.0.0.0 only behind trusted auth/proxy controls.",
        "prompt": "Telegram webhook host",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SMS_WEBHOOK_HOST": {
        "description": "Local bind host for SMS/Twilio webhook mode (default: 127.0.0.1). Use 0.0.0.0 only behind trusted auth/proxy controls.",
        "prompt": "SMS webhook host",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SMS_WEBHOOK_PUBLIC_URL": {
        "description": "External Twilio webhook URL used for signature validation when Hermes runs behind a proxy or tunnel.",
        "prompt": "SMS webhook public URL",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "SMS_INSECURE_NO_AUTH": {
        "description": "Disable SMS/Twilio webhook signature validation for local testing only (true/false).",
        "prompt": "Disable SMS webhook auth",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "SMS_MAX_WEBHOOK_BYTES": {
        "description": "Maximum SMS/Twilio webhook request body size in bytes (default: 65536).",
        "prompt": "SMS max webhook bytes",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
